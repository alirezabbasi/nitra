...
from liquidity_layer import (
    aggregate_m5_from_1m,
    augment_current_m5_with_ticks,
    build_liquidity_overlay_data,
    build_ontology_liquidity_model,
    m5_window_bounds,
)
...
def liquidity_layer_projection(
    ...
    window_start, last_closed_bucket_start, current_bucket_start = m5_window_bounds(now_utc)
    ...
    bars_5m = aggregate_m5_from_1m(one_minute_rows, current_bucket_start)
    bars_5m = augment_current_m5_with_ticks(
        bars_5m=bars_5m,
        ticks=current_bucket_ticks,
        current_bucket_start=current_bucket_start,
    )
    model = build_ontology_liquidity_model(bars_5m)
    overlay_data = build_liquidity_overlay_data(bars_5m, model)
