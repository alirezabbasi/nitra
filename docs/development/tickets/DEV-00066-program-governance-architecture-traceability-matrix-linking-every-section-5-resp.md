...
Define and deliver: Program Governance - architecture traceability matrix linking every Section 5 responsibility to code path, test gate, and runbook evidence.
