...
Define and deliver: Control Panel (P0) - raw data lake module (partition browser, replay manifest, retention controls).
...
- Delivered as consolidated control-panel raw-lake module with verification target `make test-dev-0125`.
