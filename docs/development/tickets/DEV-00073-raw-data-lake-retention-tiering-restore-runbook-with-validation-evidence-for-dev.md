...
Define and deliver: Raw Data Lake - retention/tiering/restore runbook with validation evidence for dev/staging/prod.
...
- Delivered in runtime + UI + SQL + docs with verification target `make test-dev-0073`.
