...
Define and deliver: AI Reasoning & Memory - seven-artifact governance completion pack (rulebook, scenarios, output schema, taxonomy, benchmark, prompt contract closures).
