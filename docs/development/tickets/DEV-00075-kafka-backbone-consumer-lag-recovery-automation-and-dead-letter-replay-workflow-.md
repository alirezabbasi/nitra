...
Define and deliver: Kafka Backbone - consumer lag recovery automation and dead-letter replay workflow hardening.
...
- Delivered in runtime + UI + SQL + docs with verification target `make test-dev-0075`.
