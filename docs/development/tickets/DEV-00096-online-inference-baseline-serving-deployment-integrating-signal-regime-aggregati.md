...
Define and deliver: Online Inference - baseline serving deployment integrating signal/regime/aggregation endpoints (Ray Serve only if scale need is proven).
